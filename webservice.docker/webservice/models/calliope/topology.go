...
import csv2json "webservice/models/csv2json"
...
type Feature struct {
	...
	CustomDemand csv2json.Response `json:"custom_demand_timeseries" yaml:"custom_demand_timeseries"`
}
...
type Properties struct {
	...
	Amenities     []string `json:"amenities" yaml:"amenities"`
	Area          float64  `json:"area" yaml:"area"`
	SessionID     string   `json:"hex_id" yaml:"session_id"`
	SLPClass      string   `json:"slp_class" yaml:"slp_class"`
	DemandProfile string   `json:"demand_profile" yaml:"demand_profile"`
	FClass        string   `json:"f_class" yaml:"f_class"`
	ParsedClass   string   `json:"parsed_class" yaml:"parsed_class"`
	DemandEnergy  int64    `json:"demand_energy" yaml:"demand_energy"`
	DemandHeat    float64  `json:"demand_heat" yaml:"demand_heat"`
	RatedPower    float64  `json:"rated_power" yaml:"rated_power"`
}
